...
pub fn cornell_box_specular_dragon() -> World {
    let mut world = World::default();
    ...
    dragon_var.rotate(Vector3::new(0.0, 1.0, 0.0), (2.0 - 1.0 / 5.0) * PI);
    dragon_var.scale_by_scalar(350.0);
    dragon_var.translate(Vector3::new(390.0, 95.0, 190.0));
    dragon_var.set_material(lambertian_white.clone());
