...
impl SurfaceInteraction {
    ...
    pub fn set_intersection_properties(&mut self, material: Arc<dyn Material>) {
    ...
    pub fn compute_differentials(
        ...
        if ray.has_differentials && n.dot(ray.rx_direction) != 0.0 && n.dot(ray.ry_direction) != 0.0
        {
            ...
            (self.dpdx, self.dpdy) =
                camera.approximate_dp_dxy(Point3f::from(self.pi), self.n, samples_per_pixel);
        }
